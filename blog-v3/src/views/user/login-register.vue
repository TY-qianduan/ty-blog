...
<template>
  <div class="layout">
    <div class="center-box flex flex-col justify-start items-center">
      <h1 class="welcome" @click="goTo('/home')">欢迎来到tianyang的个人博客</h1>
      <div class="login-register-bg">
        <div class="login-register-box">
          ...
          >
            ...
            <el-form-item>
              <div class="flex justify-between items-center w-[100%]">
                <span class="apply-button button-bg" type="danger" @click="submit">登录</span>
              </div>
            </el-form-item>
          </el-form>
          <el-form
          ...
          >
            ...
            <el-form-item>
              <div class="flex justify-between items-center w-[100%]">
                <span class="apply-button button-bg" @click="submit">注册</span>
              </div>
            </el-form-item>
          </el-form>
        </div>
